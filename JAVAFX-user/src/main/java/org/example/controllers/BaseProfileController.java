...
public abstract class BaseProfileController implements Initializable {
    ...
    private void applyProfileImageStyling() {
        ...
        // Keep this consistent - choose false if you want the image to fill the circle completely
    ...
    @FXML
    private void registerFace(ActionEvent event) {
        SceneManager.loadScene("/fxml/FaceRegistration.fxml", event);
