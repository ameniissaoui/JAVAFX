...
public class AdminDashboardController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        statistiqueButton.setOnAction(event -> handlestatRedirect());
    ...
    private void exportToPDF() {
        ...
        try {
            // Initialize PDF writer and document with A4 page size
            ...
            // Define ChronoSerena's brand colors with better contrast
            Color primaryBlue = new DeviceRgb(59, 130, 246); // #3b82f6
            Color accentPink = new DeviceRgb(244, 63, 94); // #f43f5e
            Color teal = new DeviceRgb(20, 184, 166); // #14b8a6
            Color amber = new DeviceRgb(245, 158, 11); // #f59e0b
            Color lightGray = new DeviceRgb(245, 247, 250); // #f5f7fa
            Color darkText = new DeviceRgb(51, 65, 85); // #334155

            // Create a Div for the header to hold the logo and title
            Div headerDiv = new Div();
            headerDiv.setKeepTogether(true);
            headerDiv.setWidth(UnitValue.createPercentValue(100)); // Span the full page width

            // Create a nested Div for the logo (left-aligned)
            Div logoDiv = new Div();
            logoDiv.setWidth(120); // Match the logo width
            ...
            // Create a nested Div for the title (centered on the page)
            Div titleDiv = new Div();
            titleDiv.setWidth(UnitValue.createPercentValue(100)); // Span the full page width
            ...
            title.setMarginTop(10); // Vertically align with the logo's center
            titleDiv.add(title);
            headerDiv.add(titleDiv);

            // Add the headerDiv to the document (this ensures a page is created)
            ...
            // Create a table with 7 columns (excluding "Actions")
            ...
            // Style the table (modern look with spacing)
            ...
            // Add a subtle shadow effect (simulated with a background rectangle)
            ...
            // Add a stylish footer with better contrast
            ...
            // Optionally, open the PDF file after creation
