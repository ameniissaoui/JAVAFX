...
import com.example.sante.Entity.Reservation;
import com.example.sante.service.ReservationService;
...
public class reservationFrontController {
    ...
    void reservationfront(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/sante/reservationFront.fxml"));
            Parent root = loader.load();
            Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
            Scene scene = new Scene(root);
            stage.setScene(scene);
    ...
    private void openReservationForm(Reservation reservation, boolean isEditMode) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/sante/updateReservation.fxml"));
            Parent root = loader.load();
    ...
    private class ReservationListCell extends ListCell<Reservation> {
        ...
        public ReservationListCell() {
            ...
            ImageView deleteIcon = new ImageView(new Image("file:src/main/resources/com/example/sante/images/delete.png"));
            ImageView editIcon = new ImageView(new Image("file:src/main/resources/com/example/sante/images/modifier.png"));
