...
public class ListEvent {
    ...
    public void onModifierClick() {
        ...
        if (selectedEvent != null) {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/sante/updateEvent.fxml"));
    ...
    public void gotoAddEvent() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/sante/addevent.fxml"));
