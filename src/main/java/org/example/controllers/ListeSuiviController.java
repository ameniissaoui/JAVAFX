...
public class ListeSuiviController implements Initializable {
    ...
    private void afficherSuivi(suivie_medical suivi) {
        try {
            ...
            URL url = getClass().getResource("/fxml/afficher_suivi.fxml");
            if (url == null) {
        ...
        public TableLikeListCell() {
            ...
            for (int i = 0; i < 3; i++) {
                ...
                if (i == 0) {
                    ...
                    column.setPrefWidth(450); // Commentaire
                } else if (i == 2) {
            ...
            // Add elements to grid - CORRECTED COLUMN INDICES
            gridPane.add(dateLabel, 0, 0);          // Date dans la première colonne
            gridPane.add(commentaireLabel, 1, 0);   // Commentaire dans la deuxième colonne
            gridPane.add(actionsBox, 2, 0);         // Actions dans la troisième colonne

// Configure button icons using Ikonli
            // View details button
            ...
            btnAfficher.setStyle("-fx-background-color: #4285F4; -fx-padding: 5px;");
        ...
        protected void updateItem(suivie_medical suivi, boolean empty) {
            ...
            if (empty || suivi == null) {
                ...
                // Configure actions buttons with spacing between them
                actionsBox.getChildren().clear();
                actionsBox.setSpacing(8); // Add spacing between buttons
