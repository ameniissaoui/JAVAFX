...
public class ProduitServices implements IServices<Produit> {
    ...
    public void addProduit(Produit produit) {
        ...
        String req = "INSERT INTO produit(nom, description, prix, stock_quantite, date, image, created_by_id) VALUES (?, ?, ?, ?, ?, ?, ?)";
    ...
    public void editProduit(Produit produit) {
        ...
        String req = "UPDATE produit SET nom=?, description=?, prix=?, stock_quantite=?, date=?, image=?, created_by_id=? WHERE id=?";
