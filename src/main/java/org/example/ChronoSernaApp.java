...
public class ChronoSernaApp extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        // Utiliser une image de logo si disponible
        // primaryStage.getIcons().add(new Image(getClass().getResource("/images/logo2.png").toExternalForm()));
        primaryStage.show();
    ...
    private VBox createHeader() {
        ...
        loginButton.setOnAction(e -> {
            try {
                ...
                ex.printStackTrace();
                showErrorAlert("Erreur de navigation", "Impossible de charger la page de connexion.");
            }
        });
        ...
        registerButton.setOnAction(e -> {
            try {
                ...
                Scene roleSelectionScene = new Scene(roleSelectionRoot);
                Stage stage = (Stage) registerButton.getScene().getWindow();
                stage.setScene(roleSelectionScene);
                stage.show();
            } catch (IOException ex) {
                ex.printStackTrace();
                showErrorAlert("Erreur de navigation", "Impossible de charger la page de sélection du rôle.");
            }
        });
