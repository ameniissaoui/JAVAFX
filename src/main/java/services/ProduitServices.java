...
public class ProduitServices implements IServices <Produit> {
    ...
    public void addProduit(Produit produit) {
        ...
        String req = "INSERT INTO sante.produit(nom, description, prix, stock_quantite, date, image) VALUES (?, ?, ?, ?, ?, ?)";
    ...
    public void removeProduit(Produit produit) {
        ...
        String req = "DELETE FROM sante.produit WHERE id = ?";
    ...
    public void editProduit(Produit produit) {
        ...
        String req = "UPDATE sante.produit SET nom=?, description=?, prix=?, stock_quantite=?, date=?, image=? WHERE id=?";
    ...
    public List<Produit> showProduit() {
        ...
        String req = "SELECT * FROM sante.produit";
    ...
    public Produit getoneProduit(int id) {
        ...
        String req = "SELECT * FROM sante.produit WHERE id = ?";
        Produit p = null;
